...
public class NodePalette extends JPanel {
    ...
    private static final String[] ICONS = { "\u25ce", "\u25a3", "\u25c9", "\u2295", "\u2328", "\u23f1",
            "\u2709" };
    private static final String[] NAMES = { "Watch Zone", "Image", "Watch Case", "Simple Click", "Keyboard", "Wait",
            "Message" };
    ...
    public NodePalette() {
        ...
        for (int i = 0; i < PALETTE_TYPES.length; i++)
            add(buildCard(PALETTE_TYPES[i], ICONS[i], NAMES[i]));
    ...
    public void setOnSmartPinClicked(Runnable cb) {
        onSmartPinClicked = cb;
    }

    public void setTargetCanvas(NodeCanvas canvas) {
        targetCanvas = canvas;
    }
        ...
        JPanel card = new JPanel() {
                ...
                addMouseListener(new MouseAdapter() {
                    ...
                    public void mousePressed(MouseEvent e) {
                        ...
                        if (targetCanvas != null)
                            targetCanvas.startGhostDrag(type);
                    }
                        ...
                        if (draggingType != null) {
                            ...
                            if (targetCanvas != null && isOverCanvas(screenPt)) {
                                ...
                                if (onNodeDropped != null)
                                    onNodeDropped.accept(type, screenPt);
                            } else {
                                if (targetCanvas != null)
                                    targetCanvas.cancelGhostDrag();
                                if (onNodeDropped != null)
            ...
            private boolean isOverCanvas(Point screenPt) {
                ...
                try {
                    ...
                    Rectangle bounds = new Rectangle(canvasLoc.x, canvasLoc.y, targetCanvas.getWidth(),
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(bg);
                g2.fillRoundRect(0, 2, getWidth() - 1, getHeight() - 4, 8, 8);
                g2.setColor(nc);
                g2.fillRoundRect(0, 2, getWidth() - 1, 3, 4, 4);
                boolean bigPalette = type == BaseNode.NodeType.KEYBOARD
                        || type == BaseNode.NodeType.SIMPLE_CLICK
                        || type == BaseNode.NodeType.MESSAGE;
                g2.setFont(new Font("SansSerif", Font.BOLD, bigPalette ? 20 : 14));
                g2.setColor(nc.brighter());
                g2.drawString(icon, 8, 22);
                g2.setFont(new Font("SansSerif", Font.PLAIN, 10));
                g2.setColor(hovered ? Color.WHITE : new Color(200, 200, 215));
                String d = name;
                while (d.length() > 1 && g2.getFontMetrics().stringWidth(d) > getWidth() - 14)
