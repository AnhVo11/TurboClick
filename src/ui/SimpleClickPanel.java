...
public class SimpleClickPanel extends JPanel implements NativeKeyListener {
    ...
    private JPanel buildIntervalPanel() {
        ...
        headerRow.setBackground(PANEL_BG); headerRow.setBorder(new EmptyBorder(2,0,2,0));
        ...
        intervalSpinnersPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, 28));
        ...
        spinnerWrapper.setBorder(new EmptyBorder(2,4,6,4));
    ...
    private JPanel buildPointsTable() {
        ...
        pointsTable.setFont(new Font("SansSerif",Font.PLAIN,12)); pointsTable.setRowHeight(26);
        ...
        scroll.setPreferredSize(new Dimension(300,120)); scroll.setBorder(BorderFactory.createLineBorder(BORDER_COL));
    ...
    private JPanel buildHotkeyPanel() {
        ...
        row1.add(startStopKeyLabel); row1.add(changeSSBtn);

        // Smart Pin hotkey row
        ...
        row2.add(smartPinKeyLabel); row2.add(changeSPBtn); row2.add(smartPinBtn2);
    ...
    private JPanel buildStatusPanel() {
        ...
        statusLabel.setFont(new Font("SansSerif",Font.BOLD,13)); statusLabel.setForeground(TEXT_DIM);
        statusLabel.setBorder(new EmptyBorder(4,10,0,0));
        clickCountLabel = new JLabel("Clicks: 0");
        clickCountLabel.setFont(new Font("SansSerif",Font.PLAIN,12)); clickCountLabel.setForeground(TEXT_DIM);
    ...
    private JPanel buildButtons() {
        ...
        p.setBackground(BG); p.setAlignmentX(Component.LEFT_ALIGNMENT);
    ...
    private void showSmartBar() {
        ...
        dragHandle.setFont(new Font("SansSerif",Font.PLAIN,16)); dragHandle.setForeground(new Color(100,100,130));
        dragHandle.setCursor(Cursor.getPredefinedCursor(Cursor.MOVE_CURSOR));

        JLabel titleLbl = new JLabel("Smart Pin");
        titleLbl.setFont(new Font("SansSerif",Font.BOLD,12)); titleLbl.setForeground(ACCENT);

        barPinCountLabel = new JLabel("Pins: "+smartPins.size());
        barPinCountLabel.setFont(new Font("SansSerif",Font.PLAIN,11)); barPinCountLabel.setForeground(TEXT_DIM);

        barCoordsLabel = new JLabel("X: ─── Y: ───");
        barCoordsLabel.setFont(new Font("Monospaced",Font.BOLD,12)); barCoordsLabel.setForeground(new Color(80,220,120));
        ...
        bar.add(sep()); bar.add(barPinCountLabel);
        bar.add(sep()); bar.add(barCoordsLabel);
    ...
    private JLabel sep(){
        JLabel s=new JLabel("|"); s.setForeground(new Color(60,60,80)); return s;
    }
        ...
        void build() {
            ...
            JPanel panel = new JPanel() {
                protected void paintComponent(Graphics g) {
                    ...
                    g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,RenderingHints.VALUE_ANTIALIAS_ON);
                    // Shadow
                    g2.setColor(new Color(0,0,0,50)); g2.fillRoundRect(3,3,getWidth()-3,getHeight()-16,12,12);
                    // Body
                    g2.setColor(new Color(20,20,32,230)); g2.fillRoundRect(0,0,getWidth()-3,getHeight()-13,12,12);
                    // Tip
                    int cx=(getWidth()-3)/2;
                    g2.fillPolygon(new int[]{cx-7,cx+7,cx},new int[]{getHeight()-13,getHeight()-13,getHeight()-1},3);
                    // Badge
                    g2.setColor(new Color(80,140,255)); g2.fillOval(4,4,20,20);
            ...
            panel.setOpaque(false); panel.setLayout(new BorderLayout());
    ...
    public void nativeKeyPressed(NativeKeyEvent e) {
        if (listeningForStartStop) {
            startStopKey=e.getKeyCode(); startStopName=NativeKeyEvent.getKeyText(e.getKeyCode());
            listeningForStartStop=false;
            SwingUtilities.invokeLater(() -> {
                startStopKeyLabel.setText("Start/Stop: ["+startStopName+"]");
                startStopKeyLabel.setForeground(TEXT_MAIN);
        ...
        if (listeningForSmartPin) {
            smartPinKey=e.getKeyCode(); smartPinName=NativeKeyEvent.getKeyText(e.getKeyCode());
            listeningForSmartPin=false;
            SwingUtilities.invokeLater(() -> {
                smartPinKeyLabel.setText("Smart Pin: ["+smartPinName+"]");
                smartPinKeyLabel.setForeground(TEXT_MAIN);
    ...
    private JSpinner dsp(int val,int min,int max){
        ...
        sp.setFont(new Font("SansSerif",Font.PLAIN,11)); sp.setPreferredSize(new Dimension(999,24)); sp.setBackground(INPUT_BG);
    ...
    private JTextField dfield(String v){
        ...
        f.setBackground(INPUT_BG); f.setForeground(TEXT_MAIN); f.setCaretColor(TEXT_MAIN);
        f.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(INPUT_BORDER),BorderFactory.createEmptyBorder(3,6,3,6)));
        return f;
    }
    private JComboBox<String> dcombo(String[] items){
        JComboBox<String> c=new JComboBox<>(items); c.setFont(new Font("SansSerif",Font.PLAIN,11));
        c.setBackground(INPUT_BG); c.setForeground(TEXT_MAIN); c.setBorder(BorderFactory.createLineBorder(INPUT_BORDER));
        return c;
    }
    private JButton dactionBtn(String text,Color accentColor){
        ...
        b.setBackground(new Color(28,28,38)); b.setForeground(accentColor); b.setOpaque(true);
        ...
        b.addMouseListener(new MouseAdapter(){
            public void mouseEntered(MouseEvent e){ b.setBackground(new Color(40,40,55)); }
            public void mouseExited(MouseEvent e){ b.setBackground(new Color(28,28,38)); }
        });
        return b;
    }
    private JButton bigBtn(String text,Color textColor,Color border){
        JButton b=new JButton(text); b.setPreferredSize(new Dimension(120,36));
        b.setFont(new Font("SansSerif",Font.BOLD,13));
        b.setBackground(new Color(28,28,38));
        b.setForeground(textColor); b.setOpaque(true);
        b.setFocusPainted(false);
        b.setBorder(BorderFactory.createCompoundBorder(
